  ...
  return (
    <><div className="min-h-screen w-full bg-[#051824] flex flex-col items-center justify-center p-6">
      ...
      {/* <button
        ...
        className={`px-4 py-2 rounded-xl text-sm font-medium shadow-md transition active:scale-95 border flex items-center gap-2 ${micOn
    ...
    </div><div className="text-sm text-cyan-100/80 font-mono ml-2 text-center">vol: {volume.toFixed(2)}</div>
    </>
  );
}